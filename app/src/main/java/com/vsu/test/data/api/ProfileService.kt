...
interface ProfileService {
    ...
    suspend fun updateProfileCoordinatesAndGetIds(
        @Body body: UpdateProfileCoordinatesRequest,
        @Query("type") type: String = "get-ids"
    ): Response<List<Long>>

    @PUT("/api/profiles/coordinates")
    suspend fun updateProfileCoordinatesAndGetEvents(
        @Body body: UpdateProfileCoordinatesRequest,
        @Query("type") type: String = "get-events"
    ...
    @GET("/api/profiles/{id}")
    suspend fun getFullProfileById(
        @Path("id") profileId: Long,
        @Query("type") type: String = "full"
    ): Response<ExtendedProfileDTO>
