...
private val eventRepository: EventRepository
    ...
    suspend fun invoke(idProfile: Long, eventDTO: EventDTO) = eventRepository.updateEvent(profileId = idProfile, eventDTO = eventDTO)
    suspend fun invoke(idProfile: Long, eventDTO: EventDTO, validate: Boolean): NetworkResult<EventDTO>
    {
        return when {
            validate -> {
                ...
                eventRepository.updateEvent(profileId = idProfile, eventDTO = eventDTO)
            }
